class MentalHealthDistressChart {
    ...
    initVis() {
        ...
        vis.svg.append("text")
           ...
           .style("fill", "#1B4F72")
           .text("Prevalence of Frequent Mental Health Distress");
        ...
        vis.svg.append("text")
           ...
           .style("font-size", "0.85rem")
           .style("fill", "#1B4F72")
           .text("Mental Health Distress Prevalence (%)");
    ...
    updateVis() {
        ...
        vis.chartData = vis.data.filter(d => 
            d.Measure.toLowerCase().includes("mental") && d.Data_Value_Type === "Age-adjusted prevalence"
        ); // cant use MeasureID because that variable changed meaning in 2023 data. 

        console.log("Mental Health chartData:", vis.chartData);
        // Sort by year 
    ...
    renderVis() {
       ...
       .call(g => g.selectAll(".tick line")
        ...
        vis.chart.selectAll(".mental-health-bar")
           .data(vis.chartData)
           .join("rect")
